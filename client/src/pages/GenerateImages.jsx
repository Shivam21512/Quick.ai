...
const GenerateImages = () => {
  ...
  const imageStyle = [
      'Realistic', 'Ghibli style', 'Anime style','Cartoon style', 'Fabtasy style',
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <textarea
          ...
          placeholder="Describe what you wnat to see in the image..."
          required
        />
      ...
      border-gray-200 min-h-96'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <h1 className='flex-1 font-semibold'>Generated Image</h1>
        </div>
