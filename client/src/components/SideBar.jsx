  ...
  return (
    <>
      ...
      <div
        ...
        items-center max-sm:fixed top-14 bottom-0 z-50
      ...
      >
        ...
        <div className="my-7 w-full">
          ...
          />
          <h1 className="mt-1 text-center font-medium text-gray-800">
            {user?.fullName}
          </h1>
...
//     items-center max-sm:fixed top-14 bottom-0 ${sidebar ? 'tranlate-x-0' :
...
//             <div className='w-full border-t boeder-gray-200 p-4 px-7 flex items-center
//             justify-between'>
//                 <div onClick={openUserProfile} className='flex gap-2 itens-center cursor-pointer'>
